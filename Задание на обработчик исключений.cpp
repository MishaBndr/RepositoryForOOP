...
public:
    ...
    Human(Human&& other) {
        try {
            ...
            other.age = 0;
            if (name.empty()) {
                throw "Ошибка перемещения: имя не может быть пустым.";
			}
        }
    ...
    Human(const Human& other) {
        try {
            ...
            quantity_of_humans++;
            if (name.empty()) {
                throw "Ошибка копирования: имя не может быть пустым.";
			}
        }
        catch (const char* msg) {
			cerr << msg << endl;
...
public:
    ...
    Apartament(Human* arr, int cnt) {
        try {
            ...
            if (count_of_humans < 0) {
                throw "Ошибка: количество жильцов не может быть отрицательным.";
			}
        }
        catch (const char* msg) {
            cerr << msg << endl;
    ...
    Apartament(const Apartament& other) {
        try {
            ...
            if (count_of_humans < 0) {
				throw "Ошибка копирования: количество жильцов не может быть отрицательным.";
                }
        }
        catch (const char* msg) {
			cerr << msg << endl;
    ...
    Apartament(Apartament&& other) {
        try {
			...
			if (count_of_humans < 0) {
            throw "Ошибка перемещения: количество жильцов не может быть отрицательным.";
            }
        }
		catch (const char* msg) {
			cerr << msg << endl;
...
public:
    House(Apartament* arr, int Count_of_apartaments) {
        try {
            ...
            if (count_of_apartaments < 0) {
				throw "Ошибка: количество квартир не может быть отрицательным.";
            }
        }
        catch (const char* msg) {
			cerr << msg << endl;
    ...
    House(const House& other) {
        try {
			...
			if (count_of_apartaments < 0) {
            throw "Ошибка копирования: количество квартир не может быть отрицательным.";
            }
        }
		catch (const char* msg) {
			cerr << msg << endl;
    ...
    while (true) {
        ...
        if (choose == 1) {
            try {
                ...
                if (choose_flat < 1 || choose_flat > 4) {
					throw "Ошибка: неверный выбор квартиры.";
                    }
            }
			catch (const char* msg) {
				cerr << msg << endl;
            ...
            try {
				...
				if (choose_to_give_new_apartament < 1 || choose_to_give_new_apartament > 3) {
					throw "Ошибка: неверный выбор квартиры.";
                }
            }
			catch (const char* msg) {
            ...
            try {
				...
				if (choose_to_move_peoples < 1 || choose_to_move_peoples > 3) {
					throw "Ошибка: неверный выбор квартиры.";
                }
            }
			catch (const char* msg) {
